...
const LOG_LINES = [
  "> clu capture --skill tamil-conversational",
  "> mic OK / device_wallet signed",
  "> recording activity... press Q to stop",
  "> groq transcribe -> SKILL.md draft",
  "> extract knowledge_graph: nodes + edges",
